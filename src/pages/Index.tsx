...
const Index = () => {
  return (
    <div className="font-vazir">
      ...
      {/* بخش تماس با ما و شبکه‌های اجتماعی با طراحی بهتر */}
      <section className="py-12 bg-gradient-to-r from-pink-50 to-purple-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-pink-500 to-purple-500 mx-auto my-3 rounded-full"></div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <a 
              ...
              className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-full hover:shadow-lg hover:shadow-pink-300/50 transition-all duration-300 transform hover:scale-105"
            >
            ...
            <a 
              ...
              className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-500 to-teal-500 text-white rounded-full hover:shadow-lg hover:shadow-green-300/50 transition-all duration-300 transform hover:scale-105"
            >
